DataSet
---------
You will find the used data set which came from Kagle competition Bag of Words Meets Bags of Popcorn.
I have attached it in DataSet Folder
...
HOW TO RUN
------------
Just you should run the code in capstone-project.ipynb
